...
extern void Put_animated_background(unsigned short a, unsigned char f);
extern void Put_sprite(unsigned short a, short x, short y, unsigned short w, unsigned short h, unsigned char f, float scale);
extern void Put_sprite_rot(unsigned short a, short x, short y, unsigned short w, unsigned short h, unsigned char f, float scale, unsigned short angle);
